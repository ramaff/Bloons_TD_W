...
function scr_tower_attack(_tower_stats = tower_stats, _current_boosts = {}, _range_boost = 0, _targeting = targeting){
	...
	scr_create_tower_projectiles(_tower_stats.projectile_stats, x, y, target, _angle_offset, _current_boosts, _tower_stats.id)
