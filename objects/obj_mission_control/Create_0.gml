...
instance_create_depth(0, 0, depth, obj_pause_button)
instance_create_depth(32, 0, depth, obj_settings_button)
instance_create_depth(96, 0, depth, obj_round_go_button)
