...
scr_draw_outline_text(172, 4, "Round")
scr_draw_outline_text(240, 4, string(global.round) + "/" + string(array_length(global.bloon_sends)))
scr_draw_outline_text(176, 32, scr_timer_string(global.total_time))
